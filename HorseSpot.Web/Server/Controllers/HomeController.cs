...
namespace HorseSpot.Web.Controllers
{
  public class HomeController : Controller
  {
    ...
    public async Task<IActionResult> SitemapXml()
    {
      ...
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/home</loc>";
      ...
      xml += "</url>";
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/horses-for-sale/showjumping/1</loc>";
      ...
      xml += "</url>";
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/horses-for-sale/dressage/1</loc>";
      ...
      xml += "</url>";
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/horses-for-sale/eventing/1</loc>";
      ...
      xml += "</url>";
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/horses-for-sale/endurance/1</loc>";
      ...
      xml += "</url>";
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/horses-for-sale/driving/1</loc>";
      ...
      xml += "</url>";
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/horses-for-sale/foals/1</loc>";
      ...
      xml += "</url>";
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/horses-for-sale/leisure/1</loc>";
      ...
      xml += "</url>";
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/horses/add<loc>";
      ...
      xml += "</url>";
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/advertise</loc>";
      xml += "<lastmod>" + DateTime.Now.ToString("yyyy-MM-dd") + "</lastmod>";
      xml += "</url>";
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/hire-us</loc>";
      xml += "<lastmod>" + DateTime.Now.ToString("yyyy-MM-dd") + "</lastmod>";
      xml += "</url>";
      xml += "<url>";
      xml += "<loc>https://www.horse-spot.com/contact</loc>";
      xml += "<lastmod>" + DateTime.Now.ToString("yyyy-MM-dd") + "</lastmod>";
      xml += "</url>";
      xml += "</urlset>";
