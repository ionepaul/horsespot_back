...
export class ProfileComponent implements OnInit {
    @ViewChild('changePasswordModal') public changePasswordModal: Modal; 
    @ViewChild('sendEmailFromProfile') public sendEmailModal: Modal;
    ...
    ngOnInit() {
        ...
        this._accountService.getUserFullProfile(this.userId)
                            .subscribe(response => { this.userModel = response;
    ...
    changePassword() {
        this._accountService.changePassword(this.userId, this.changePasswordModel)
                            .subscribe(response => { this.changePasswordModal.close();
                                                     this.notificationRefresh++; 
        ...
        if (this.profilePhoto != null) {
            this._accountService.uploadProfilePhoto(this.profilePhoto, this.userId)
                                .subscribe(result => {
                                    ...
                                    this.profilePhotoUrl = CONFIG.imagesUrl + '/Images/ProfilePhotos/';
